...
from Literals.literals import add_separator, MONTH_MAP
...
def CreateCorrectPhotoshootPage(parent, show_page):
    ParentFrame = Frame(parent)
    MainTitle = Label(ParentFrame, text="Correction In Photoshoots", pady=18, font=("Arial", 25, "bold"), bg="White")
    ...
    #this statement registers an attribute named - "update_dropdown" to this python frame
    ...
    def validate_fetch_Populate_OrdersList(event):
        """
        ...
        records = get_Client_orders(client, month_number,"Photoshoot")
        ...
        if records:
            unique_order_id = get_order_id_list(client,month_number,"Photoshoot")
            IDSelection['state'] = "readonly"
